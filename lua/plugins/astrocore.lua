function ReplaceTextInQuotes()
  -- Yank the text inside quotes
  vim.cmd 'normal! vi"'

  -- Delete the text inside quotes
  vim.cmd "normal! p"
end
  ...
  opts = {
    ...
    mappings = {
      ...
      n = {
        ...
        vim.api.nvim_set_keymap("n", "<leader>rp", ":lua ReplaceTextInQuotes()<CR>", { noremap = true, silent = true }),
